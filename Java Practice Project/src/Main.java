...
//            }
//        }
//        // create object of class method
//        Methods method1 = new Methods();
//        // call method of class Methods by using object method1
//        method1.animal("Horse", "shhhhh!!");
//        method1.animal("Cat", "meow!!");
//        // call addition method and put returned value in sum
//        double sum = method1.addition(25, 30); // double method
//        System.out.println(sum);
//        // call method checkAge
//        method1.checkAge(27);
//        // method overloading
//        int sum2 = method1.addition(20,50); // method name same, int method - type changed
//        System.out.println(sum2);
//        int sum3 = method1.addition(25, 35, 100); // method name same, int method - number of parameters changed
//        System.out.println(sum3);
//        // scope check
//        method1.checkScope();

        // create object of class Recursions
        Recursions recursion1 = new Recursions();
        // call the method of Recursions class
        int multipliedSum = recursion1.multiplication(3, 6);
        System.out.println(multipliedSum);
        // call method sum with one int end value
        int recursiveSum = recursion1.sum(10); // answer = 55
        System.out.println("Sum of 0 to given value is " + recursiveSum);
